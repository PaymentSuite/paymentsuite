 ...
 */
class BankwireExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('bankwire.controller.route', $config['controller_route']);
        $container->setParameter('bankwire.success.route', $config['payment_success']['route']);
